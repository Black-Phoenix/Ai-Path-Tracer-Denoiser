...
1		For this render, we see no reflections at all. The is basically the albedo buffer, required later
...
7		The difference is subtle but it shows up in the 3rd order reflections
